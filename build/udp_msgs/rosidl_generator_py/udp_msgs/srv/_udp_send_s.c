...
bool udp_msgs__srv__udp_send__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("udp_msgs.srv._udp_send.UdpSend_Request", full_classname_dest, 38) == 0);
  }
  udp_msgs__srv__UdpSend_Request * ros_message = _ros_message;
  {  // local_address
...
{
  /* NOTE(esteve): Call constructor of UdpSend_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("udp_msgs.srv._udp_send");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "UdpSend_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool udp_msgs__srv__udp_send__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("udp_msgs.srv._udp_send.UdpSend_Response", full_classname_dest, 39) == 0);
  }
  udp_msgs__srv__UdpSend_Response * ros_message = _ros_message;
  {  // sent
    ...
    ros_message->sent = (Py_True == field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of UdpSend_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("udp_msgs.srv._udp_send");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "UdpSend_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
  ...
  {  // sent
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->sent ? 1 : 0);
    {
