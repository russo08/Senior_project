...
#include "udp_msgs/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _UdpSend_Request_type_support_symbol_names_t _UdpSend_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, udp_msgs, srv, UdpSend_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, udp_msgs, srv, UdpSend_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_udp_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, udp_msgs, srv, UdpSend_Request)() {
  return &::udp_msgs::srv::rosidl_typesupport_c::UdpSend_Request_message_type_support_handle;
}
...
static const _UdpSend_Response_type_support_symbol_names_t _UdpSend_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, udp_msgs, srv, UdpSend_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, udp_msgs, srv, UdpSend_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_udp_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, udp_msgs, srv, UdpSend_Response)() {
  return &::udp_msgs::srv::rosidl_typesupport_c::UdpSend_Response_message_type_support_handle;
}
...
static const _UdpSend_type_support_symbol_names_t _UdpSend_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, udp_msgs, srv, UdpSend)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, udp_msgs, srv, UdpSend)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, udp_msgs, srv, UdpSend)() {
  return &::udp_msgs::srv::rosidl_typesupport_c::UdpSend_service_type_support_handle;
}
