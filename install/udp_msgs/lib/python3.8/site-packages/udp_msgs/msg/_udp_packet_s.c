...
bool udp_msgs__msg__udp_packet__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("udp_msgs.msg._udp_packet.UdpPacket", full_classname_dest, 34) == 0);
  }
  udp_msgs__msg__UdpPacket * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of UdpPacket */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("udp_msgs.msg._udp_packet");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "UdpPacket");
