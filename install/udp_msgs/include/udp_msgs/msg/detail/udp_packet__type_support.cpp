...
{
  new (message_memory) udp_msgs::msg::UdpPacket(_init);
}

void UdpPacket_fini_function(void * message_memory)
{
  auto typed_message = static_cast<udp_msgs::msg::UdpPacket *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember UdpPacket_message_member_array[4] = {
  {
    "header",  // name
    ...
    offsetof(udp_msgs::msg::UdpPacket, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(udp_msgs::msg::UdpPacket, address),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(udp_msgs::msg::UdpPacket, src_port),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(udp_msgs::msg::UdpPacket, data),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers UdpPacket_message_members = {
  "udp_msgs::msg",  // message namespace
  "UdpPacket",  // message name
  4,  // number of fields
  sizeof(udp_msgs::msg::UdpPacket),
...
{
  return &::udp_msgs::msg::rosidl_typesupport_introspection_cpp::UdpPacket_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, udp_msgs, msg, UdpPacket)() {
  return &::udp_msgs::msg::rosidl_typesupport_introspection_cpp::UdpPacket_message_type_support_handle;
}
